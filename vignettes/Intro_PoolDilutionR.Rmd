...
pdr_optimize_df(time = OneSample_dat$time_days,
...
all_results <- lapply(samples, FUN = function(samples) {
   pdr_optimize_df(time = samples$time_days,
...
new_fit<- pdr_optimize_df(time = Sample64_dat$time_days,
...
y_new <- pdr_predict(time = Sample64_dat$time_days,
