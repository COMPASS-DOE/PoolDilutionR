...
# graph new fit
ggplot(data = dat_new) +
  geom_point(aes(time_days, AP_pred, color = "New Prediction"), size = 3) +
  geom_point(aes(time_days, AP_obs, color = "Observations"), size = 3) +
  geom_point(aes(time_days, oldAPpred, color = "Old Prediction"),
              size = 3) +
  scale_color_manual(
    name = "",
    breaks = c("New Prediction", "Observations", "Old Prediction"),
    values = c("New Prediction" = "red", "Observations" = "#619CFF", "Old Prediction" = "black")
  ) +
  ylab("Atom%13C\n")
