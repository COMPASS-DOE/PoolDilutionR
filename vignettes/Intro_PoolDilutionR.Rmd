...
original_fit<- pdr_optimize_tidy(time = Sample64_dat$time_days,
...
#long_comparison <- pivot_longer(Morris2023, cols = cal12CH4ml:AP_obs)

#graph two fits
ggplot(data = comparison) +
  geom_point(aes(time_days, (nt/(mt+nt))), color = "red") +
  geom_point(aes(time_days, (cal13CH4ml/(cal12CH4ml+cal13CH4ml))), color = "blue") +
  facet_grid(.~fit)
```
